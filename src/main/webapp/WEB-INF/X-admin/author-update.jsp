...
<body>
<div class="x-body">
    <form class="layui-form" action="${pageContext.request.contextPath }/authorupdate/${author.author_id}" enctype="multipart/form-data" method="post">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="author_name" name="author_name"  required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="${author.author_name}">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" value="${author.author_image}" id="author_image0" class="layui-input" placeholder="请选择图片文件" disabled/>
                <input type="file" id="author_image" name="author_image"  required="" lay-verify="phone"
                       autocomplete="off" class="layui-input" value="${author.author_image}" style="display: none">
                <img src="${pageContext.request.contextPath}/AuthorShowImage?picName=${author.author_image}" id="author_image2" style="width: 20rem;height: 15rem;">
            </div>
        </div>
...
<script>
    $("#author_image2").click(function() {
        $("#author_image").trigger("click");
    });
    $("#author_image").change(function(){
        var x = document.getElementById("author_image").files;
        $("#author_image0").val(x[0].name);
