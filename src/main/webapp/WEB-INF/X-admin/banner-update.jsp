...
<body>
<div class="x-body">
    <form class="layui-form" action="${pageContext.request.contextPath }/bannerupdate/${banner.banner_id}" enctype="multipart/form-data" method="post">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="banner_name" name="banner_name"  required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="${banner.banner_name}">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" value="${banner.banner_image}" id="banner_image0" class="layui-input" placeholder="请选择图片文件" disabled/>
                <input type="file" id="banner_image" name="banner_image"  required="" lay-verify="phone"
                       autocomplete="off" class="layui-input" value="${banner.banner_image}" style="display: none">
                <img src="${pageContext.request.contextPath}/BannerShowImage?picName=${banner.banner_image}" id="banner_image2" style="width: 20rem;height: 15rem;">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="banner_weizhi" name="banner_weizhi"  required="" lay-verify="phone"
                       ...
                       onafterpaste="this.value=this.value.replace(/\D/g,'')" value="${banner.banner_weizhi}">
            </div>
        </div>
...
<script>
    $("#banner_image2").click(function() {
        $("#banner_image").trigger("click");
    });
    $("#banner_image").change(function(){
        var x = document.getElementById("banner_image").files;
        $("#banner_image0").val(x[0].name);
