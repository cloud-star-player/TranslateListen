...
<body>
<div class="x-body">
    <form class="layui-form" action="${pageContext.request.contextPath }/TouXiangupload" enctype="multipart/form-data" method="post">
        <div class="layui-form-item">
            <label for="touxiang_image" class="layui-form-label">
                <span class="x-red">*</span>TouXiang图片
            </label>
            <div class="layui-input-inline">
                <input type="file" id="touxiang_image" name="touxiang_image"  required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
                <img src="" id="touxiang_image2" style="width: 20rem;height: 15rem;">
            </div>
        </div>
